        ...
        "image": function(locale, options) {
           ...
           return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                "<div id='local-images-holder'></div>"+
                
                "</div>" +
                "<div class='modal-footer'>" +
                  "<input value='http://' class='bootstrap-wysihtml5-insert-image-url input-xlarge' style='float: left;' id='local-image-url'>" +  
...
// some code about images
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["/template/assets/css/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
